...
import com.turtle.airquality.databinding.ActivityMainBinding
import com.turtle.airquality.retrofit.AirQualityResponse
import com.turtle.airquality.retrofit.AirQualityService
import com.turtle.airquality.retrofit.RetrofitConnection
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getAirQualityData(latitude: Double, longitude: Double) { // 레트로핏 객체를 이용하면 AirQualityService 인터페이스 구현체를 가져올 수 있습니다.
        ...
        var API_KEY = getApplicationContext().getResources().getString(R.string.AIRVISUAL);
    ...
    private fun getCurrentAddress(latitude: Double, longitude: Double): Address? {
        ...
        Log.d("tag1", addresses[0]?.toString())
        return addresses[0]
    }
